...
function saveAlarm(){
    ...
    function x(){
        document.getElementById("settime").innerHTML = "Alarm is "+hour+":"+minute+":"+second;
        document.getElementById("settime").style.fontSize="large";
        document.getElementById("settime").style.fontWeight="bold";
        document.getElementById("settime").style.paddingLeft="100px";
        document.getElementById("settime").style.paddingRight="45px";
